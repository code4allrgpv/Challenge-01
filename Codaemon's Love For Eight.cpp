...
// Solution is available on the above given link.
...
int main() {
    ...
    string s;
    cin>>s;
    if(s.size() == 1){if(stoi(s)%8 == 0){cout<<"Yes";return 0;}else{cout<<"No";return 0;}}
    if(s.size() == 2){if(stoi(s)%8 == 0){cout<<"Yes";return 0;}reverse(s.begin(), s.end());if(stoi(s)%8 == 0){cout<<"Yes";return 0;}else{cout<<"No";return 0;}}
